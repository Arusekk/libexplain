...
/**
  * The explain_lseek function may be used to interpret a lseek "call"
  * from the command line, and then run it through libexplain_errno_lseek
  * for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_lseek(int errnum, int argc, char **argv);
