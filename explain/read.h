...
/**
  * The explain_read function may be used to interpret a read "call"
  * from the command line, and then run it through libexplain_errno_read
  * for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_read(int errnum, int argc, char **argv);
