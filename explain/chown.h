...
#ifndef EXPLAIN_CHOWN_H
#define EXPLAIN_CHOWN_H

/**
  * The explain_chown function may be used to
  * interpret a chown "call" from the
  * command line, and then run it through
  * libexplain_errno_chown for an explanation.
  *
  * @note
  * Because the event being explain happened in another
  * process, the results are not as good as if
  * libexplain_errno_chown had been called
  ...
  *    1:1 to the call arguments.
  */
void explain_chown(int errnum, int argc, char **argv);

#endif /* EXPLAIN_CHOWN_H */
