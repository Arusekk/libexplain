...
void
explain_select(int errnum, int argc, char **argv)
{
    int             nfds;
    fd_set          readfds;
    fd_set          *readfds_p;
    ...
    case 4:
        exceptfds_p = (fd_set *)libexplain_strtol_or_die(argv[3]);
        /* fall through... */

    case 3:
        writefds_p = (fd_set *)libexplain_strtol_or_die(argv[2]);
        /* fall through... */

    case 2:
        readfds_p = (fd_set *)libexplain_strtol_or_die(argv[1]);
        /* fall through... */

    case 1:
        nfds = libexplain_strtol_or_die(argv[0]);
        break;
