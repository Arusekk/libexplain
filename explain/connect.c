...
void
explain_connect(int errnum, int argc, char **argv)
{
    int             fildes;
    ...
    {
    case 3:
        serv_addr_size = libexplain_strtol_or_die(argv[2]);
        ...
        serv_addr = (struct sockaddr *)libexplain_strtol_or_die(argv[1]);
        /* fall through... */
    ...
    (
        stdout,
        libexplain_errno_connect(errnum, fildes, serv_addr, serv_addr_size)
    );
}
