...
/**
  * The explain_open function may be used to interpret a open "call"
  * from the command line, and then run it through libexplain_errno_open
  * for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_open(int errnum, int argc, char **argv);
