...
#ifndef EXPLAIN_FCHMOD_H
#define EXPLAIN_FCHMOD_H


/**
  * The explain_fchmod function may be used to interpret a fchmod "call"
  * from the command line, and then run it through libexplain_errno_fchmod
  * for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_fchmod(int errnum, int argc, char **argv);

#endif /* EXPLAIN_FCHMOD_H */
