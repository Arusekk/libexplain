...
/**
  * The explain_creat function may be used to interpret a creat "call"
  * from the command line, and then run it through libexplain_errno_creat
  * for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_creat(int errnum, int argc, char **argv);
