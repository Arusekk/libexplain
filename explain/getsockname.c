...
void
explain_getsockname(int errnum, int argc, char **argv)
{
    int             fildes;
    ...
    {
    case 3:
        sock_addr_size = libexplain_strtol_or_die(argv[2]);
        /* fall through... */

    case 2:
        sock_addr_p = (struct sockaddr *)libexplain_strtol_or_die(argv[1]);
        /* fall through... */
