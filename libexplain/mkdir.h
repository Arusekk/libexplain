...
/**
  * The libexplain_mkdir_or_die function is
  ...
  * @code
  * libexplain_mkdir_or_die(pathname, mode);
  * @endcode
  *
  * @param pathname
  *     The pathname, exactly as to be passed to the mkdir(2) system call.
  * @param mode
  *     The mode, exactly as to be passed to the mkdir(2) system call.
  * @returns
  *     This function only returns on success.
  *     On failure, prints an explanation and exits,
  *     it does not return.
  */
void libexplain_mkdir_or_die(const char *pathname, int mode);

/**
  * The libexplain_mkdir function is used to
...
/**
  ...
  *     The original mode, exactly as passed to the mkdir(2) system call.
  */
void libexplain_message_mkdir(char *message, int message_size,
    const char *pathname, int mode);

/**
  * The libexplain_message_errno_mkdir
