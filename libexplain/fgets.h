...
/**
  * The libexplain_fgets_or_die function is
  * used to call the fgets(3) system call.  On
  * failure an explanation will be printed to stderr,
  * obtained from libexplain_fgets(3), and
  ...
  * @code
  * libexplain_fgets_or_die(data, data_size, fp);
  * @endcode
  *
  * @param data
  ...
  *     it does not return.
  */
char *libexplain_fgets_or_die(char *data, int data_size, FILE *fp);

/**
  * The libexplain_fgets function is used to
...
/**
  ...
  * {
  *     int err = errno;
  *     fprintf(stderr, "%s\n", libexplain_fgets(err, data, data_size, fp));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  *
...
/**
  ...
  * {
  *     char message[3000];
  *     libexplain_message_fgets(message, sizeof(message), data, data_size, fp);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  ...
  *     The original fp, exactly as passed to the fgets(3) system call.
  */
void libexplain_message_fgets(char *message, int message_size, char *data,
    int data_size, FILE *fp);

/**
  * The libexplain_message_errno_fgets
  ...
  *     int err = errno;
  *     char message[3000];
  *     libexplain_message_errno_fgets(message, sizeof(message), err,
  *         data, data_size, fp);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  *     The original fp, exactly as passed to the fgets(3) system call.
  */
void libexplain_message_errno_fgets(char *message, int message_size, int errnum,
