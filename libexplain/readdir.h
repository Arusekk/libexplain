...
/**
  * The libexplain_readdir_or_die function is
  ...
  * @code
  * libexplain_readdir_or_die(dir);
  * @endcode
  *
  * @param dir
  *     The dir, exactly as to be passed to the readdir(2) system call.
  * @returns
  *     a pointer to a dirent structure, or NULL if end-of-file is
  *     reached.  On failure, prints an explanation and exits, it does
  *     not return.
  */
struct dirent *libexplain_readdir_or_die(DIR *dir);

/**
  * The libexplain_readdir function is used to
  * obtain an explanation of an error returned by the
  * readdir(2) system call.
...
/**
  ...
  *     The original dir, exactly as passed to the readdir(2) system call.
  */
void libexplain_message_readdir(char *message, int message_size, DIR *dir);

/**
  * The libexplain_message_errno_readdir
