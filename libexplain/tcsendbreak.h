...
#ifndef LIBEXPLAIN_TCSENDBREAK_H
#define LIBEXPLAIN_TCSENDBREAK_H

/**
  * @file
  * @brief explain tcsendbreak(3) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>tcsendbreak</i>(3) system call.
  */
...
/**
  * The explain_tcsendbreak_or_die function is used to call the
  * <i>tcsendbreak</i>(3) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_tcsendbreak</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param fildes
  *     The fildes, exactly as to be passed to the <i>tcsendbreak</i>(3)
  *     system call.
  * @param duration
  *     The duration, exactly as to be passed to the <i>tcsendbreak</i>(3)
  *     system call.
  * @returns
  *     This function only returns on success, see <i>tcsendbreak</i>(3)
...
/**
  * The explain_tcsendbreak_on_error function is used to call the
  * <i>tcsendbreak</i>(3) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_tcsendbreak</i>(3)
  * function.
  *
  ...
  *     system call.
  * @returns
  *     The value returned by the wrapped <i>tcsendbreak</i>(3) system
  *     call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
...
/**
  ...
  * error returned by the <i>tcsendbreak</i>(3) system call. The least the
  ...
  * #explain_tcsendbreak_or_die function.
  */
...
/**
  ...
  * of an error returned by the <i>tcsendbreak</i>(3) system call. The
...
/**
  ...
  * #explain_tcsendbreak_or_die function.
  */
void explain_message_tcsendbreak(char *message, int message_size, int fildes,
    int duration);
...
#endif /* LIBEXPLAIN_TCSENDBREAK_H */
