...
/**
  * The libexplain_gettimeofday_or_die function is
  * used to call the gettimeofday(2) system call.  On
  * failure an explanation will be printed to stderr,
  * obtained from libexplain_gettimeofday(3), and
  ...
  * struct timeval *tv;
  * struct timezone *tz;
  * libexplain_gettimeofday_or_die(&tv, &tz);
  * @endcode
  *
  * @param tv
  *     The tv, exactly as to be passed to the gettimeofday(2) system call.
  * @param tz
  *     The tz, exactly as to be passed to the gettimeofday(2) system call.
  * @returns
  *     This function only returns on success.
  *     On failure, prints an explanation and exits,
  *     it does not return.
  */
void libexplain_gettimeofday_or_die(struct timeval *tv, struct timezone *tz);

/**
  * The libexplain_gettimeofday function is used to
...
/**
  ...
  * {
  *     int err = errno;
  *     fprintf(stderr, "%s\n", libexplain_gettimeofday(err, tv, tz));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  *
...
/**
  ...
  * {
  *     char message[3000];
  *     libexplain_message_gettimeofday(message, sizeof(message), tv, tz);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  ...
  *     The original tz, exactly as passed to the gettimeofday(2) system call.
  */
void libexplain_message_gettimeofday(char *message, int message_size,
    struct timeval *tv, struct timezone *tz);

/**
  * The libexplain_message_errno_gettimeofday
  ...
  *     int err = errno;
  *     char message[3000];
  *     libexplain_message_errno_gettimeofday(message, sizeof(message),
  *         err, tv, tz);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  *     The original tz, exactly as passed to the gettimeofday(2) system call.
  */
void libexplain_message_errno_gettimeofday(char *message, int message_size,
