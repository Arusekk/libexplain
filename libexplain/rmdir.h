...
/**
  * The libexplain_rmdir_or_die function is
  ...
  * @code
  * libexplain_rmdir_or_die(pathname);
  * @endcode
  *
  * @param pathname
  ...
  */
void libexplain_rmdir_or_die(const char *pathname);

/**
  * The libexplain_rmdir function may be used
  * to describe errors returned by the rmdir()
...
/**
  ...
  *     The original pathname, exactly as passed to the rmdir(2) system call.
  */
void libexplain_message_rmdir(char *message, int message_size,
    const char *pathname);

/**
  * The libexplain_message_errno_rmdir
  * function may be used to describe errors returned by
  * the rmdir() system call.  The least the
  * message will contain is the value of strerror(errnum),
  * but usually it will do much better, and indicate the
  * underlying cause in more detail.
  *
