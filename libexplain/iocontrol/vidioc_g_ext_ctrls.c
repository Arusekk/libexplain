    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)errnum;
    (void)request;
    explain_buffer_v4l2_ext_controls(sb, data, 0, fildes);
}
    ...
    case EINVAL:
        {
            ...
            for (j = 0; j < arg->count; ++j)
            {
                ...
                )
                {
                    ...
                    snprintf(name, sizeof(name), "data->controls[%d].id", j);
...
const explain_iocontrol_t explain_iocontrol_vidioc_g_ext_ctrls =
{
    "VIDIOC_G_EXT_CTRLS", /* name */
    VIDIOC_G_EXT_CTRLS, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
