    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    case EINVAL:
        if (explain_is_efault_pointer(data, sizeof(struct scc_stat)))
            goto efault;
        /* Fall through... */
    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_scc_stat(sb, data);
}


const explain_iocontrol_t explain_iocontrol_siocsccgstat =
{
    "SIOCSCCGSTAT", /* name */
    SIOCSCCGSTAT, /* value */
    ...
    print_explanation,
    print_data_returned,
    sizeof(struct scc_stat), /* data_size */
    "struct scc_stat *", /* data_type */
    IOCONTROL_FLAG_SIZE_DOES_NOT_AGREE, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef SIOCSCCGSTAT */
