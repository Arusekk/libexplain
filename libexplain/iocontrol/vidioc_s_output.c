...
const explain_iocontrol_t explain_iocontrol_vidioc_s_output =
{
    "VIDIOC_S_OUTPUT", /* name */
    VIDIOC_S_OUTPUT, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
