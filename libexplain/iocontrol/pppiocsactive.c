    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    case EINVAL:
        explain_buffer_einval_sock_fprog(sb, uprog);
        break;
...
const explain_iocontrol_t explain_iocontrol_pppiocsactive =
{
    "PPPIOCSACTIVE", /* name */
    PPPIOCSACTIVE, /* value */
    0, /* disambiguate */
