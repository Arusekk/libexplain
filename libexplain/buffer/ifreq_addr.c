...
void
libexplain_buffer_ifreq_addr(libexplain_string_buffer_t *sb,
    const struct ifreq *data)
{
    ...
    else
    {
        ...
        libexplain_string_buffer_puts(sb, ", ifr_addr = ");
        libexplain_buffer_sockaddr(sb, &ifr->ifr_addr, sizeof(ifr->ifr_addr));
