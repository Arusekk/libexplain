...
/**
  * The libexplain_buffer_eacces function may be used to
  *
  * @param sb
  ...
  */
void libexplain_buffer_eacces(libexplain_string_buffer_t *sb,
    const char *pathname, const char *caption,
    const struct libexplain_final_t *final_component);
