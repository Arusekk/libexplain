...
/**
  * The libexplain_buffer_errno_wait function
  ...
  */
void libexplain_buffer_errno_wait(libexplain_string_buffer_t *sb, int errnum,
    int *status);

/**
  * The libexplain_buffer_errno_wait_explanation function is used by the
  * libexplain_buffer_errno_wait function (and others) to describe the
  * problem in detail.
  *
  * @param sb
  ...
  *     The original status, exactly as passed to the wait(2) system call.
  */
void libexplain_buffer_errno_wait_explanation(libexplain_string_buffer_t *sb,
