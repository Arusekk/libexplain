...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_SOCKET_H
#define LIBEXPLAIN_BUFFER_ERRNO_SOCKET_H

#include <libexplain/string_buffer.h>

/**
  * The libexplain_buffer_errno_socket function
  ...
  */
void libexplain_buffer_errno_socket(libexplain_string_buffer_t *sb, int errnum,
