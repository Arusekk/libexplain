...
static void
libexplain_buffer_errno_fputc_system_call(libexplain_string_buffer_t *sb,
    int errnum, int c, FILE *fp)
{
    (void)errnum;
    libexplain_string_buffer_puts(sb, "fputc(c = ");
...
static void
libexplain_buffer_errno_fputc_explanation(libexplain_string_buffer_t *sb,
    int errnum, int c, FILE *fp)
{
    int             fildes;
...
void
libexplain_buffer_errno_fputc(libexplain_string_buffer_t *sb, int errnum, int c,
    FILE *fp)
{
    libexplain_explanation_t exp;

    libexplain_explanation_init(&exp, errnum);
    libexplain_buffer_errno_fputc_system_call
    (
        &exp.system_call_sb,
        errnum,
        c,
    ...
    libexplain_buffer_errno_fputc_explanation
    (
        &exp.explanation_sb,
        errnum,
        c,
