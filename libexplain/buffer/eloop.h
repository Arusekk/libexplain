...
/**
  * The libexplain_buffer_eloop function may be used to provide a common
  ...
  */
void libexplain_buffer_eloop(libexplain_string_buffer_t *sb,
    const char *pathname, const char *pathname_caption,
    const struct libexplain_final_t *pathname_final_component);

/**
  * The libexplain_buffer_eloop2 function may be used to provide a common
  ...
  */
void libexplain_buffer_eloop2(libexplain_string_buffer_t *sb,
