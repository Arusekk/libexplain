...
/**
  * The libexplain_bind_or_die function is
  * used to call the bind(2) system call.  On
  * failure an explanation will be printed to stderr,
  * obtained from libexplain_bind(3), and
  ...
  * @code
  * libexplain_bind_or_die(fildes, sock_addr, sock_addr_size);
  * @endcode
  *
  * @param fildes
  ...
  *     it does not return.
  */
void libexplain_bind_or_die(int fildes, const struct sockaddr *sock_addr,
    int sock_addr_size);

/**
  * The libexplain_bind function is used to
  ...
  * the #libexplain_bind_or_die function.
  *
  * @param fildes
  ...
  */
const char *libexplain_bind(int fildes, const struct sockaddr *sock_addr,
    int sock_addr_size)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_errno_bind function is
  ...
  *     many other functions in this library.
  */
const char *libexplain_errno_bind(int errnum, int fildes,
    const struct sockaddr *sock_addr, int sock_addr_size)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_message_bind function is
  * used to obtain an explanation of an error returned by
  * the bind(2) system call.
  * The least the message will contain is the value of
  * strerror(errno), but usually it will do much better,
  ...
  * {
  *     char message[3000];
  *     libexplain_message_bind(message, sizeof(message),
  *         fildes, sock_addr, sock_addr_size);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  *     system call.
  */
void libexplain_message_bind(char *message, int message_size, int fildes,
    const struct sockaddr *sock_addr, int sock_addr_size);

/**
  * The libexplain_message_errno_bind
  ...
  *     int err = errno;
  *     char message[3000];
  *     libexplain_message_errno_bind(message, sizeof(message), err,
  *         fildes, sock_addr, sock_addr_size);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  *     system call.
  */
void libexplain_message_errno_bind(char *message, int message_size, int errnum,
