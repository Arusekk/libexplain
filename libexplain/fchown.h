...
/**
  * The libexplain_fchown_or_die function is
  * used to call the fchown(2) system call.  On
  * failure an explanation will be printed to stderr,
  * obtained from libexplain_fchown(3), and
  ...
  * @code
  * libexplain_fchown_or_die(fildes, owner, group);
  * @endcode
  *
  * @param fildes
  *     The fildes, exactly as to be passed to the fchown(2) system call.
  * @param owner
  *     The owner, exactly as to be passed to the fchown(2) system call.
  * @param group
  *     The group, exactly as to be passed to the fchown(2) system call.
  * @returns
  *     This function only returns on success.
  *     On failure, prints an explanation and exits,
  *     it does not return.
  */
void libexplain_fchown_or_die(int fildes, int owner, int group);

/**
  * The libexplain_fchown function is used to
  * obtain an explanation of an error returned by the
  * fchown(2) system call.
  ...
  * the #libexplain_fchown_or_die function.
  *
  * @param fildes
  ...
  */
const char *libexplain_fchown(int fildes, int owner, int group)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_errno_fchown function is
  ...
  * {
  *     int err = errno;
  *     fprintf(stderr, "%s\n", libexplain_fchown(err, fildes, owner, group));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  *
  ...
  *     many other functions in this library.
  */
const char *libexplain_errno_fchown(int errnum, int fildes, int owner,
    int group)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_message_fchown function is
  * used to obtain an explanation of an error returned by
  * the fchown(2) system call.
  * The least the message will contain is the value of
  * strerror(errno), but usually it will do much better,
  ...
  * {
  *     char message[3000];
  *     libexplain_message_fchown(message, sizeof(message),
  *         fildes, owner, group);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  *     The original group, exactly as passed to the fchown(2) system call.
  */
void libexplain_message_fchown(char *message, int message_size, int fildes,
    int owner, int group);

/**
  * The libexplain_message_errno_fchown
  ...
  *     int err = errno;
  *     char message[3000];
  *     libexplain_message_errno_fchown(message, sizeof(message),
  ...
  *     The original group, exactly as passed to the fchown(2) system call.
  */
void libexplain_message_errno_fchown(char *message, int message_size,
