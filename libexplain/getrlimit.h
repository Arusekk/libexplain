...
/**
  * The libexplain_getrlimit_or_die function is
  * used to call the getrlimit(2) system call.  On
  * failure an explanation will be printed to stderr,
  * obtained from libexplain_getrlimit(3), and
  ...
  *
  * @param resource
  *     The resource, exactly as to be passed to the getrlimit(2) system call.
  * @param rlim
  *     The rlim, exactly as to be passed to the getrlimit(2) system call.
  * @returns
  *     This function only returns on success.
  *     On failure, prints an explanation and exits,
  *     it does not return.
  */
void libexplain_getrlimit_or_die(int resource, struct rlimit *rlim);

/**
  * The libexplain_getrlimit function is used to
  ...
  * {
  *     fprintf(stderr, "%s\n", libexplain_getrlimit(resource, rlim));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  *
  * The above code example is available pre-packaged as
  * the #libexplain_getrlimit_or_die function.
  * @param resource
  ...
  */
const char *libexplain_getrlimit(int resource, struct rlimit *rlim)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_errno_getrlimit function is
  ...
  * {
  *     int err = errno;
  *     fprintf(stderr, "%s\n", libexplain_getrlimit(err, resource, rlim));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  *
  ...
  *     many other functions in this library.
  */
const char *libexplain_errno_getrlimit(int errnum, int resource,
    struct rlimit *rlim)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_message_getrlimit function is
  * used to obtain an explanation of an error returned by
  * the getrlimit(2) system call.
  * The least the message will contain is the value of
  * strerror(errno), but usually it will do much better,
  ...
  * {
  *     char message[3000];
  *     libexplain_message_getrlimit(message, sizeof(message),
  *         resource, rlim);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  *     The original rlim, exactly as passed to the getrlimit(2) system call.
  */
void libexplain_message_getrlimit(char *message, int message_size, int resource,
    struct rlimit *rlim);

/**
  * The libexplain_message_errno_getrlimit
  ...
  *     int err = errno;
  *     char message[3000];
  *     libexplain_message_errno_getrlimit(message, sizeof(message),
  *         err, resource, rlim);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  *     The original rlim, exactly as passed to the getrlimit(2) system call.
  */
void libexplain_message_errno_getrlimit(char *message, int message_size,
