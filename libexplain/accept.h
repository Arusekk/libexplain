...
/**
  * The libexplain_accept_or_die function is used to call the accept(2)
  * system call.  On failure an explanation will be printed to stderr,
  * obtained from libexplain_accept(3), and then the process terminates
  * by calling exit(EXIT_FAILURE).
  *
  * This function is intended to be used in a fashion
  * similar to the following example:
  * @code
  * libexplain_accept_or_die(fildes, sock_addr, sock_addr_size);
  * @endcode
  *
  * @param fildes
  ...
  *     The sock_addr_size, exactly as to be passed to the accept(2)
  *     system call.
  * @returns
  ...
  *     does not return.
  */
int libexplain_accept_or_die(int fildes, struct sockaddr *sock_addr,
    socklen_t *sock_addr_size);

/**
  * The libexplain_accept function is used to
  ...
  * {
  *     fprintf(stderr, "%s\n", libexplain_accept(fildes, sock_addr,
  *         sock_addr_size));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  ...
  * the #libexplain_accept_or_die function.
  *
  * @param fildes
  ...
  *     this library.
  */
const char *libexplain_accept(int fildes, struct sockaddr *sock_addr,
    socklen_t *sock_addr_size)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_errno_accept function is used to obtain an
  ...
  * {
  *     int err = errno;
  *     fprintf(stderr, "%s\n", libexplain_accept(err, fildes, sock_addr,
  *         sock_addr_size));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  ...
  *     this library.
  */
const char *libexplain_errno_accept(int errnum, int fildes,
    struct sockaddr *sock_addr, socklen_t *sock_addr_size)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_message_accept function is used to obtain an
  * explanation of an error returned by the accept(2) system call.  The
  ...
  * {
  *     char message[3000];
  *     libexplain_message_accept(message, sizeof(message), fildes, sock_addr,
  *         sock_addr_size);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  *     system call.
  */
void libexplain_message_accept(char *message, int message_size, int fildes,
    struct sockaddr *sock_addr, socklen_t *sock_addr_size);

/**
  * The libexplain_message_errno_accept function is used to obtain an
  * explanation of an error returned by the accept(2) system call.  The
  * least the message will contain is the value of strerror(errnum), but
  * usually it will do much better, and indicate the underlying cause in
  * more detail.
  ...
  *     int err = errno;
  *     char message[3000];
  *     libexplain_message_errno_accept(message, sizeof(message), err, fildes,
  ...
  *     system call.
  */
void libexplain_message_errno_accept(char *message, int message_size,
