...
/**
  * The libexplain_lchown_or_die function is
  * used to call the lchown(2) system call.  On
  * failure an explanation will be printed to stderr,
  * obtained from libexplain_lchown(3), and
  ...
  * @code
  * libexplain_lchown_or_die(pathname, owner, group);
  * @endcode
  *
  * @param pathname
  ...
  *     it does not return.
  */
void libexplain_lchown_or_die(const char *pathname, int owner, int group);

/**
  * The libexplain_lchown function is used to
  * obtain an explanation of an error returned by the
  * lchown(2) system call.
...
/**
  ...
  * {
  *     int err = errno;
  *     fprintf(stderr, "%s\n", libexplain_lchown(err, pathname, owner, group));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  *
...
/**
  ...
  * {
  *     char message[3000];
  *     libexplain_message_lchown(message, sizeof(message),
  ...
  *     The original group, exactly as passed to the lchown(2) system call.
  */
void libexplain_message_lchown(char *message, int message_size,
    const char *pathname, int owner, int group);

/**
  * The libexplain_message_errno_lchown
  ...
  *     int err = errno;
  *     char message[3000];
  *     libexplain_message_errno_lchown(message, sizeof(message), err,
  *         pathname, owner, group);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  *     The original group, exactly as passed to the lchown(2) system call.
  */
void libexplain_message_errno_lchown(char *message, int message_size,
