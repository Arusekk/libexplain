...
/**
  ...
  * error returned by the link(2) system call.  The least the message
...
/**
  * The libexplain_message_link function is used to obtain an
  * explanation of an error returned by the link(2) system call.  The
...
/**
  * The libexplain_errno_link function is used to obtain an explanation
  * of an error returned by the link(2) system call.  The least the
...
/**
  ...
  *     The original newpath, exactly as passed to the link(2) system call.
  */
void libexplain_message_errno_link(char *message, int message_size,
