...
/**
  * The libexplain_message_stat function is used to obtain an
  * explanation of an error returned by the stat(2) function.  The
...
/**
  * The libexplain_errno_stat function is used to obtain an
  * explanation of an error returned by the stat(2) function.  The
  ...
  *     this library.
  */
const char *libexplain_errno_stat(int errnum, const char *pathname,
    const struct stat *buf);

/**
  * The libexplain_message_errno_stat function is used to obtain an
  * explanation of an error returned by the stat(2) function.  The
  * least the message will contain is the value of strerror(errnum), but
  * usually it will do much better, and indicate the underlying cause in
  * more detail.
