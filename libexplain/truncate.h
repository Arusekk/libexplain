...
/**
  * The libexplain_truncate_or_die function is
  ...
  * @code
  * libexplain_truncate_or_die(pathname, length);
  * @endcode
  *
  * @param pathname
  ...
  *     it does not return.
  */
void libexplain_truncate_or_die(const char *pathname, long long length);

/**
  * The libexplain_truncate function is used to
  * obtain an explanation of an error returned by the
  * truncate(2) system call.
...
/**
  ...
  *     The original length, exactly as passed to the truncate(2) system call.
  */
void libexplain_message_truncate(char *message, int message_size,
    const char *pathname, long long length);

/**
  * The libexplain_message_errno_truncate
