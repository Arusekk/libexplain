...
/**
  * The libexplain_getsockname_or_die function is used to call the
  * getsockname(2) system call.  On failure an explanation will be
  * printed to stderr, obtained from libexplain_getsockname(3), and then
  ...
  * libexplain_getsockname_or_die(fildes, &sock_addr, &sock_addr_size);
  * @endcode
  *
  * @param fildes
  *     The fildes, exactly as to be passed to the getsockname(2) system call.
  * @param sock_addr
  *     The sock_addr, exactly as to be passed to the getsockname(2)
  *     system call.
  ...
  *     it does not return.
  */
void libexplain_getsockname_or_die(int fildes, struct sockaddr *sock_addr,
    socklen_t *sock_addr_size);

/**
  * The libexplain_getsockname function is used to
  ...
  * the #libexplain_getsockname_or_die function.
  *
  * @param fildes
  ...
  */
const char *libexplain_getsockname(int fildes, struct sockaddr *sock_addr,
    socklen_t *sock_addr_size)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_errno_getsockname function is
  ...
  * {
  *     int err = errno;
  *     fprintf(stderr, "%s\n", libexplain_getsockname(err, fildes,
  *         &sock_addr, &sock_addr_size));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  ...
  *     many other functions in this library.
  */
const char *libexplain_errno_getsockname(int errnum, int fildes,
    struct sockaddr *sock_addr, socklen_t *sock_addr_size)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The libexplain_message_getsockname function is
  * used to obtain an explanation of an error returned by
  * the getsockname(2) system call.
  * The least the message will contain is the value of
  * strerror(errno), but usually it will do much better,
  ...
  * {
  *     char message[3000];
  *     libexplain_message_getsockname(message, sizeof(message),
  ...
  *     getsockname(2) system call.
  */
void libexplain_message_getsockname(char *message, int message_size, int fildes,
    struct sockaddr *sock_addr, socklen_t *sock_addr_size);

/**
  * The libexplain_message_errno_getsockname
  ...
  *     int err = errno;
  *     char message[3000];
  *     libexplain_message_errno_getsockname(message, sizeof(message),
  ...
  *     getsockname(2) system call.
  */
void libexplain_message_errno_getsockname(char *message, int message_size,
