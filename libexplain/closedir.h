...
/**
  * The libexplain_closedir_or_die function is
  * used to call the closedir(3) system call.  On
  * failure an explanation will be printed to stderr,
  * obtained from libexplain_closedir(3), and
  ...
  * @code
  * libexplain_closedir_or_die(dir);
  * @endcode
  *
  * @param dir
  *     The dir, exactly as to be passed to the closedir(3) system call.
  * @returns
  *     This function only returns on success.
  *     On failure, prints an explanation and exits,
  *     it does not return.
  */
void libexplain_closedir_or_die(DIR *dir);

/**
  * The libexplain_closedir function is used to
  * obtain an explanation of an error returned by the
  * closedir(3) system call.
...
/**
  ...
  * {
  *     char message[3000];
  *     libexplain_message_closedir(message, sizeof(message), dir);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  ...
  *     The original dir, exactly as passed to the closedir(3) system call.
  */
void libexplain_message_closedir(char *message, int message_size, DIR *dir);

/**
  * The libexplain_message_errno_closedir
  ...
  *     int err = errno;
  *     char message[3000];
  *     libexplain_message_errno_closedir(message, sizeof(message), err, dir);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  ...
  *     The original dir, exactly as passed to the closedir(3) system call.
  */
void libexplain_message_errno_closedir(char *message, int message_size,
    int errnum, DIR *dir);
