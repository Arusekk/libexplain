...
/**
  * The libexplain_ftruncate_or_die function is
  ...
  * @code
  * libexplain_ftruncate_or_die(fildes, length);
  * @endcode
  *
  * @param fildes
  ...
  *     it does not return.
  */
void libexplain_ftruncate_or_die(int fildes, long long length);

/**
  * The libexplain_ftruncate function is used to
...
/**
  ...
  *     The original length, exactly as passed to the ftruncate(2) system call.
  */
void libexplain_message_ftruncate(char *message, int message_size, int fildes,
    long long length);

/**
  * The libexplain_message_errno_ftruncate
